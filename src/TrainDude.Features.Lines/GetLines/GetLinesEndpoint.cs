...
public static class GetLinesEndpoint
{
    ...
    [Tags("Lines")]
    public static async Task<GetLinesQueryResponse> Handle([AsParameters] GetLinesQuery request, IQuerySession session, CancellationToken cancellationToken = default)
    {
        ...
        return new GetLinesQueryResponse(items);
    }
}
    ...
    : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult<BasePolymorphicQueryResult>> Handle([FromBody] BasePolymorphicQuery request)
    {
        ...
        if (response is not BasePolymorphicQueryResult polymorphicResponse)
        {
            if (response == null)
            {
